module github.com/threeport/tptctl

replace github.com/nukleros/eks-cluster => /home/lander2k2/Projects/src/github.com/nukleros/eks-cluster
...
require (
	...
	github.com/nukleros/eks-cluster v0.1.0
